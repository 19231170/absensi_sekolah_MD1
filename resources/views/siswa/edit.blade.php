                    ...
                    <form method="POST" action="{{ route('siswa.update', $siswa->nis) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nomor_hp') is-invalid @enderror" 
                                   id="nomor_hp" name="nomor_hp" value="{{ old('nomor_hp', $siswa->nomor_hp) }}">
                            @error('nomor_hp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status_aktif') is-invalid @enderror" 
                                ...
                                <option value="1" {{ old('status_aktif', $siswa->status_aktif) == '1' ? 'selected' : '' }}>
                                    <i class="fas fa-check-circle"></i> Aktif
                                </option>
                                <option value="0" {{ old('status_aktif', $siswa->status_aktif) == '0' ? 'selected' : '' }}>
